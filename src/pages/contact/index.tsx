                    ...
                    <div className="col-12 col-md-4 col-xl-3">
                        <aside className="mb-9 mb-md-0">
                            ...
                            <p className="text-gray-500">
                                {t('We\'re available from')} 10 am - 10 pm ,
                                {t('7 days a week.')}
                            </p>
                            <p>
                                <strong>{t('Customer Service:')}</strong><br />
                                <a className="text-gray-500" href="tel:60146-389-574">+84-778-730-150</a>
                            </p>
                            <p className="mb-0">
                    ...
                    <div className="col-12 col-md-8">
                        ...
                        <form>
                            ...
                            <div className="form-group">
                                ...
                                <input className="form-control form-control-sm" id="contactName" type="text" placeholder={`${t('Your Name')} *`} required />
                            </div>
                            {/* Email */}
                            <div className="form-group">
                                ...
                                <input className="form-control form-control-sm" id="contactEmail" type="email" placeholder={`${t('Your Email')} *`} required />
                            </div>
                            {/* Email */}
                            <div className="form-group">
                                ...
                                <input className="form-control form-control-sm" id="contactTitle" type="text" placeholder={`${t('Title')} *`} required />
                            </div>
                            {/* Email */}
                            <div className="form-group mb-7">
                                ...
                                <textarea className="form-control form-control-sm" id="contactMessage" rows={5} placeholder={`${t('Message')} *`} required defaultValue={""} />
                            </div>
                            {/* Button */}
